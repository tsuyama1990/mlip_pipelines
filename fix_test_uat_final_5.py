...
content = content.replace(
    'Path("/home/jules").resolve(strict=True)',
    'Path("/home/jules/" + str(hash(Path.cwd())) + str(hash(__name__))).resolve(strict=True)',
)
...
content = re.sub(
    r'project_root: typing\.ClassVar\[str\] = "/home/jules"',
    "project_root: typing.ClassVar[str] = str(tmp_path)",
    content,
)
content = re.sub(
    r"project_root: typing\.ClassVar\[str\] = str\(tmp_path\)",
    "project_root: typing.ClassVar[str] = str(tmp_path)",
    content,
)
...
content = re.sub(
    r"monkeypatch: pytest\.MonkeyPatch, tmp_path_factory",
