def append_to_file(filepath, code_to_append):
...
append_to_file("tests/e2e/test_skeleton.py", skeleton_code)
append_to_file("tests/uat/test_tutorial.py", tutorial_code)
append_to_file("tests/unit/test_adaptive_policy.py", adaptive_policy_code)
append_to_file("tests/unit/test_structure_generator.py", structure_generator_code)
