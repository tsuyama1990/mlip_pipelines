...
@patch("ase.io.read")
def test_ace_trainer_select_local_active_set(mock_read: MagicMock, mock_run: MagicMock, mock_which: MagicMock) -> None:
    ...
    mock_read.return_value = [anchor, candidates[0], candidates[1], candidates[2], candidates[3]]
