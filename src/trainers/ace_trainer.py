...
class ACETrainer:
    ...
    def select_local_active_set(
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            try:
                ...
                selected_from_file = read(str(tmpdir / "selected.extxyz"), index=":")
                if not isinstance(selected_from_file, list):
    ...
    def _build_pace_train_cmd(
        ...
        # For fine-tuning, strictly apply the initial potential if present
    ...
    def train(self, dataset: Path, initial_potential: Path | None, output_dir: Path) -> Path:
        """
        Runs Pacemaker training, applying LJ baseline configuration.
        """
