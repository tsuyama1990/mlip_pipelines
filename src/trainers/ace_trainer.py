...
class PacemakerWrapper(AbstractTrainer, BinaryResolverMixin):
    ...
    def _build_train_command(
        ...
        # We do NOT use shlex.quote here because subprocess.run(shell=False)
        # automatically handles escaping argument elements.
        cmd = [
            pace_train_bin,
            "--dataset",
            dataset_str,
        ...
        if initial_potential and initial_potential.exists():
            ...
            cmd.extend(["--initial_potential", str(resolved_init_pot)])
