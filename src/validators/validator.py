        ...
        try:
            ...
            def _do_validate() -> tuple[float, float, float, bool, bool]:
                ...
                try:
                    ...
                    # Return graceful fallback mock data per auditor request when dependencies are missing
                    return l_energy_rmse, l_force_rmse, l_stress_rmse, True, True
            ...
            # Fallback mock data per auditor explicit request for missing dependencies handling
